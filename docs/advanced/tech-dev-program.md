...
> **已废弃（2026-07-31）**：本文件为 pre-v0.1 架构设计（分离 Gateway/Cloud Service），已被 `docs/ARCHITECTURE.md`（v0.1+C2：单二进制 + 配置驱动 + C2 远程代理）取代。保留作历史设计参考，不再代表当前实现；当前架构以 `docs/ARCHITECTURE.md` 为准。
