...
> **v0.1 状态（2026-07-31）**：本文件从 git 历史恢复并按 lowercase-kebab 重命名（原 `docs/REFACTORING_BACKLOG.md`）。内容为历史积压清单（截至 2026-06-26）；其中涉及已移除能力（vector/embedding、Eval、Pipeline、Webhook、OSS、OTel、PostgreSQL、自升级）的条目，按 `docs/ARCHITECTURE.md` 第 10 节作为 post-v0.1 独立功能推进，不视为 v0.1 待办。v0.1 范围内已解决的事项见 `docs/ARCHITECTURE.md` 第 9 节。
